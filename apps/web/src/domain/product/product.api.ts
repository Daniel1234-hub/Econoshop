...
export class ProductApi {
  ...
  static findManyBySupplierId(
    ...
    return HttpService.api.get(
      `/v1/suppliers/supplier/${supplierId}/products${buildOptions}`,
    )
  }

  static createOneBySupplierId(
    supplierId: string,
    values: Partial<Product>,
  ): Promise<Product> {
    return HttpService.api.post(
      `/v1/suppliers/supplier/${supplierId}/products`,
      values,
    )
  }
}
